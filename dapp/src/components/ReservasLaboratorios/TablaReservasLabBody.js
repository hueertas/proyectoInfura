...
import TablaReservasLabRow from "./TablaReservasLabRow";
...
const ReservarPuestosBody = ({indexlab,fecha,NAsignatura}) => {
    ...
    for (let i = 0; i < puestosIndices.length; i++) {
            ...
            rows.push(<TablaReservasLabRow key={"cb-"+i} puestoIndice={puestosIndices[i]} fecha={fecha} indexlab={indexlab} NAsignatura={NAsignatura}/>);
    }
