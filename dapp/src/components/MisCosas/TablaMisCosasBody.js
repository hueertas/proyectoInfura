...
import TablaMisCosasRow from "./TablaMisCosasRow";
...
const TablaMisCosasBody = ({indexlab,fecha,NAsignatura}) => {
    ...
    for (let i = 0; i < puestosIndices.length; i++) {
            ...
            rows.push(<TablaMisCosasRow key={"cb-"+i} puestoIndice={puestosIndices[i]} fecha={fecha} indexlab={indexlab} NAsignatura={NAsignatura}/>);
    }
...
export default TablaMisCosasBody;